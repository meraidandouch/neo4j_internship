...
file_collection = {}
file = {}
file_df = pd.read_csv('pathway/to/data/GTEx_Analysis_v6_RNA-seq_RNA-SeQCv1.1.8_gene_reads.csv', skiprows = 2, sep='\t')
...
for keys, values in file_collection.items():
    ...
    df.to_csv('pathway/to/data/'+ keys +".csv",  sep=',', index = False, header = True)
